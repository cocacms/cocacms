...
import {
  Table, Form, Row, Col, Button, Input, Modal, Select, TreeSelect, Tag
} from 'antd';
...
class CategoryPage extends Component {
  ...
  getColumns = () => ([
    ...
    },
    {
      ...
      render: (text, record, index) => {
        return (
          <Action
            can={{ edit: 'PUT@/api/category/:id', delete: 'DELETE@/api/category/:id'}}
            editable={false}
            deleteable={false}
          >
  ...
  render() {
    const { loading: { effects: loading = {}}, category: { list = [], models = [] } } = this.props;
